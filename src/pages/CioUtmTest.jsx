...
function CioUtmTest() {
  ...
  const hasUtms = UTM_KEYS.some((key) => sessionStorage.getItem(key) !== null);
    ...
    <div className="app-container">
      ...
      <div className="main-grid">
        <div className="config-column">
          ...
          <div className="card">
            <h2 className="utm-card-title">Stored UTM Values (sessionStorage)</h2>
            <table className="utm-table">
              ...
              <tbody>
                {UTM_KEYS.map((key) => (
                  <tr key={key}>
                    <td>{key}</td>
                    <td className="utm-value-cell">{utmValues[key] || <span className="utm-empty">not set</span>}</td>
                  </tr>
                ))}
              </tbody>
            </table>
